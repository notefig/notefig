---
title: Publish to Coolify
description: Deploy your book to Coolify, a self-hosted deployment solution.
order: 8
---
# Coolify
...
2. In your Coolify dashboard: create a new application, connect your Git repository, and Coolify will automatically detect the `nixpacks.toml` configuration.
