---
title: Editor
description: A desktop application for writing and publishing books, with git integration and one-click deploys.
order: 2
---
# Editor
...
Download the latest release from [GitHub](https://github.com/notefig/notefig/releases).

**Web (Chrome only)**

Use the browser version: [app.notefig.com](https://app.notefig.com)
