...
const headingVariants = cva("relative mb-1", {
  variants: {
    variant: {
      ...
      h2: "mt-[0.85em] pb-px font-heading font-semibold text-2xl tracking-tight",
      h3: "mt-[0.7em] pb-px font-heading font-semibold text-xl tracking-tight",
      h4: "mt-[0.55em] font-heading font-semibold text-lg tracking-tight",
      h5: "mt-[0.55em] font-semibold text-lg tracking-tight",
      h6: "mt-[0.55em] font-semibold text-base tracking-tight",
    },
  },
});
