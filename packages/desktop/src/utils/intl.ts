    ...
    resources: {
      en: {
        translation: {
          ...
          autoSaveCheckpoints: "Auto-save checkpoints",
          ...
          initializeTimeline: "Initialize timeline",
          repairTimeline: "Repair timeline",
          retry: "Retry",
          timelineNotInitializedTitle: "Timeline not initialized",
          timelineNotInitializedMessage: "Project timeline is not initialized.",
          timelineBusyTitle: "Timeline is busy",
          timelineBusyMessage: "Project timeline is busy.",
          timelineCorruptTitle: "Timeline needs repair",
          timelineCorruptMessage: "Project timeline metadata is inconsistent.",
